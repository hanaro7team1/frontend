...
import { LoanCard, ReservationBtn, UpcommingStayCard } from '@/components/domain/home/city';
...
export default async function HomePage({ params }: Props) {
  ...
  return (
    <div className='relative flex flex-col'>
      ...
      <header className='flex items-center justify-center z-1'>
      ...
      <main className='space-y-5 px-4 z-1'>
